        ...
        <div className="footer-content">
          ...
          <div className="footer-section footer-certificates">
            ...
            <div className="certificates">
              <div 
                className="certificate-item clickable-certificate" 
                onClick={() => window.open('/documents/qms-certificate.pdf', '_blank')}
                style={{ cursor: 'pointer' }}
              >
                <img src="/images/sertifikat1.png" alt="ISO 9001:2015" />
                <span>ISO 9001:2015</span>
              </div>
              <div 
                className="certificate-item clickable-certificate"
                onClick={() => window.open('/documents/ohs-certificate.pdf', '_blank')}
                style={{ cursor: 'pointer' }}
              >
                <img src="/images/sertifikat2.png" alt="ISO 45001:2018" />
                <span>ISO 45001:2018</span>
              </div>
              <div 
                className="certificate-item clickable-certificate"
                onClick={() => window.open('/documents/ems-certificate.pdf', '_blank')}
                style={{ cursor: 'pointer' }}
              >
                <img src="/images/sertifikat3.png" alt="ISO 14001:2015" />
                <span>ISO 14001:2015</span>
              </div>
              <div 
                className="certificate-item clickable-certificate"
                onClick={() => window.open('/documents/iso-15088-certificate.pdf', '_blank')}
                style={{ cursor: 'pointer' }}
              >
                <img src="/images/sertifikat4.png" alt="EN 15088:2005" />
                <span>EN 15088:2005</span>
              </div>
            </div>
            
            <div className="company-info">
              <div className="company-logo">
                <img src="/images/FINAL-LOGO-BELI.png" alt="MTC" />
              </div>
